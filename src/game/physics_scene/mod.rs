...
impl<'a> PhysicsScene<'a> {
    ...
    fn resolve_collision(a : &mut Body, b : &mut Body, pc_percent : f32, pc_slop : f32) -> Option<message::Message> {
        ...
        match collision_data {
            Some(data) => {
                ...
                if velocity_along_normal > 0.0 { return msg; }
    ...
    fn resolve_collisions(&mut self) -> Vec<message::Message> {
        ...
        for a in 0..dynamic_body_count {
            for b in 0..dynamic_body_count {
                ...
                let msg = Self::resolve_collision(a_body, b_body, 
